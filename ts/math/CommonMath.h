...
extern bool equalsWithEpsilon(float lhs, float rhs, float epsilon = FLOAT_EPSILON);
extern bool equalsWithEpsilon(double lhs, double rhs, double epsilon = DOUBLE_EPSILON);
