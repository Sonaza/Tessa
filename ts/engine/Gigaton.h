...
#define TS_GIGATON_REGISTER_CLASS(instance) ::ts::engine::Gigaton::getSingleton().registerClass(instance)
#define TS_GIGATON_UNREGISTER_CLASS(instance) ::ts::engine::Gigaton::getSingleton().unregisterClass(instance)

#define TS_GET_GIGATON() ::ts::engine::Gigaton::getSingleton()
